...
FONT = ImageFont.truetype("/System/Library/Fonts/HelveticaNeue.dfont", 14)
LINE_SPACING = 5


def get_font_area_size(text, spacing = LINE_SPACING, font = FONT):
    """
    returns a tuple, (w, h)
    """
    draw = ImageDraw.Draw(Image.new('RGB', (0,0)))
    draw.multiline_textsize(text, spacing = LINE_SPACING, font = FONT)

# TODO: use textarea wrap
